...
function LogindbDao.query(uid, requestmsg)
	return msgproxy.sendrpc_reqmsgto_logindbsvrd(nil, uid, "dao", "query", requestmsg)
end

function LogindbDao.querybysvrid(svr_id, requestmsg)
	requestmsg.uid = 1	
	return msgproxy.sendrpc_reqmsgto_logindbsvrd(svr_id, 1, "dao", "query", requestmsg)
end
